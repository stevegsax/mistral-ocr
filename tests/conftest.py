...
# Import shared fixtures for reuse across test modules
...
def httpx_mock_responses():
    ...
    return {
        ...
        "GET https://api.mistral.ai/v1/batch/jobs": {
            "json": {
                "data": [
                    {"id": "job-1", "status": "completed", "created_at": "2024-01-01T10:00:00Z"},
                    {"id": "job-2", "status": "running", "created_at": "2024-01-01T10:05:00Z"},
                ]
            }
        },
    }
