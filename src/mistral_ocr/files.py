...
class FileCollector:
    ...
    def collect_files(self, paths: List[pathlib.Path], recursive: bool = False) -> List[pathlib.Path]:
    ...
    def _collect_from_directory(self, directory: pathlib.Path, recursive: bool) -> List[pathlib.Path]:
