...
# Retry management exceptions
class RetryableError(MistralOCRError):
    ...
    def __init__(
        ...
        self.retry_after = retry_after  # Seconds to wait before retry (from API headers)


class NonRetryableError(MistralOCRError):
