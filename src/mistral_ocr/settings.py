...
class Settings:
    ...
    def get_progress_enabled(self) -> bool:
        ...
        """
        return self._config.get_progress_enabled()
    ...
    def set_progress_enabled(self, enabled: bool) -> None:
        ...
        """
        self._config.set_progress_enabled(enabled)
    ...
    def get_job_monitor_interval(self) -> int:
        ...
        """
        return self._config.get_job_monitor_interval()
    ...
    def set_job_monitor_interval(self, interval: int) -> None:
        ...
        """
        self._config.set_job_monitor_interval(interval)
